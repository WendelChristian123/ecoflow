        ...
        <Card className="p-6 max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <div
                        className={`p-4 rounded-xl border transition-all cursor-pointer ${settings.commitments ? 'bg-indigo-500/10 border-indigo-500/50' : 'bg-slate-800/50 border-slate-700/50 opacity-60'}`}
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <div className={`w-10 h-5 rounded-full relative transition-colors ${settings.commitments ? 'bg-indigo-500' : 'bg-slate-600'}`}>
                    ...
                    <div
                        className={`p-4 rounded-xl border transition-all cursor-pointer ${settings.tasks ? 'bg-emerald-500/10 border-emerald-500/50' : 'bg-slate-800/50 border-slate-700/50 opacity-60'}`}
                    ...
                    >
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <div className={`w-10 h-5 rounded-full relative transition-colors ${settings.tasks ? 'bg-emerald-500' : 'bg-slate-600'}`}>
                ...
                {/* Level 3: Finance */}
                <div className={`p-4 rounded-xl border transition-all ${settings.financial.enabled ? 'bg-amber-500/5 border-amber-500/30' : 'bg-slate-800/50 border-slate-700/50 opacity-60'}`}>
                    <div className="flex items-center justify-between mb-6 cursor-pointer" onClick={() => handleToggle('financial')}>
                        <h3 className="font-medium text-white flex items-center gap-2">
                            <DollarSign size={18} className="text-amber-400" />
                            Financeiro (Macro)
                        </h3>
                        <div className={`w-10 h-5 rounded-full relative transition-colors ${settings.financial.enabled ? 'bg-amber-500' : 'bg-slate-600'}`}>
                    ...
                    {settings.financial.enabled && (
                        <div className="space-y-3 pl-4 border-l-2 border-amber-500/20">
                            ...
                            >
                                <span className="text-sm text-slate-300">Orçamentos (Validade)</span>
                                <div className={`w-8 h-4 rounded-full relative transition-colors ${settings.financial.budgets ? 'bg-emerald-500' : 'bg-slate-700'}`}>
                            ...
                            >
                                <span className="text-sm text-slate-300">Contas a Receber</span>
                                <div className={`w-8 h-4 rounded-full relative transition-colors ${settings.financial.receivable ? 'bg-emerald-500' : 'bg-slate-700'}`}>
                            ...
                            >
                                <span className="text-sm text-slate-300">Contas a Pagar</span>
                                <div className={`w-8 h-4 rounded-full relative transition-colors ${settings.financial.payable ? 'bg-emerald-500' : 'bg-slate-700'}`}>
                            ...
                            >
                                ...
                                <div className={`w-8 h-4 rounded-full relative transition-colors ${settings.financial.credit_card ? 'bg-emerald-500' : 'bg-slate-700'}`}>
