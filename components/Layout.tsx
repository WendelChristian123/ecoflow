        ...
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <div className="text-right hidden md:block">
                    <p className="text-sm font-medium text-slate-100 max-w-[150px] truncate">{userName}</p>
                    <p className={cn("text-[10px] uppercase tracking-wider font-bold", isSuperAdmin ? "text-indigo-400" : "text-slate-400")}>
                        {getRoleLabel()}
                    </p>
                </div>
