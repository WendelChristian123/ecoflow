...
export interface KanbanStage {
  ...
  isLocked?: boolean; // If true, cannot be renamed/deleted
  isDefault?: boolean; // If true, it was created by system
  affectsDashboard?: boolean; // If true, it counts towards main KPIs
  createdAt: string;
}
