                ...
                <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
                    <div className="relative flex-1 min-w-[140px] md:w-64 md:flex-none group">
                        ...
                        <Input
                            ...
                            className="pl-8 h-7 text-[10px] bg-muted/40 border-transparent hover:bg-muted/60 focus:bg-background focus:border-emerald-500/50 transition-all rounded-lg w-full"
                        />
                    </div>
                    <Button variant="ghost" size="sm" className="h-7 gap-1.5 text-[10px] shrink-0" onClick={() => setIsReportOpen(true)}>
                        <FileText size={14} /> <span className="hidden sm:inline">Relatórios</span>
                    </Button>
                    <Button size="sm" className="h-7 px-3 gap-1.5 text-[10px] bg-emerald-500 hover:bg-emerald-600 text-white shadow-sm shrink-0" onClick={() => { setEditingContact(undefined); setIsModalOpen(true); }}>
