      ...
      <div className="w-full max-w-[400px] relative z-10">
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800/60 rounded-3xl shadow-2xl p-8 relative overflow-hidden group">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <Button type="submit" className="w-full py-3 text-base rounded-xl font-bold shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all mt-4" disabled={loading}>
