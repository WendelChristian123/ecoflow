...
export function useAuthorization(tenantId?: string, userId?: string) {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            // A. Fetch Tenant Modules (Layer 1)
    ...
    useEffect(() => {
        ...
        const sub1 = supabase
            ...
            .on('postgres_changes', { event: '*', schema: 'public', table: 'tenant_modules', filter: `tenant_id=eq.${tenantId}` }, fetchData)
