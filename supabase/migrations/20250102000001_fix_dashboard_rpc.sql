...
BEGIN
    ...
    -- 3. Finance
    -- FIX: Exclude credit_card_id IS NOT NULL from overdue/due expenses calculations
    -- because they are part of a credit card invoice, not individual bills to be paid.
    SELECT
