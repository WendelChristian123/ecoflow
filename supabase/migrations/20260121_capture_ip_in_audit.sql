-- Migration: Capture IP from request headers in Audit Logs
-- Date: 2026-01-21
-- Author: EcoFlow AI
...
DECLARE
    ...
    v_ip_address text;  -- NEW VARIABLE
BEGIN
    -- 0. Identify IP (NEW)
    -- Try custom header first, then standard forwarded-for
    BEGIN
    ...
    EXCEPTION WHEN OTHERS THEN
        v_ip_address := null; -- Safe fallback if headers are weird
    END;
    ...
    -- Insert Log (UPDATED with ip_address)
